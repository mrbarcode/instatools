...
{M}   | |   | | \   || |      |  ( \ \ 
{C}___) (___| )  \  || (____/\|  /  \ \
{C}\_______/|/    )_)(_______/|_/    \/
							 	
		     {U}{Y}~ {G}Information Getter {M}- {G}By MrBarcode {Y}~{UR}'''.format(Y=YELLOW,M=MAGENTA,G=GREEN,GR=GRAY,C=CYAN,U=UNDERLINE,UR=RUNDERLINE)
...
def Clear():
	if os.name == 'nt':
		os.system('cls')
		os.system('title 𝓘𝓷𝓯𝓸𝓻𝓶𝓪𝓽𝓲𝓸𝓷 𝓖𝓮𝓽𝓽𝓮𝓻 𝓑𝔂 𝓜𝓻𝓑𝓪𝓻𝓬𝓸𝓭𝓮')
	else:
		os.system('clear')
